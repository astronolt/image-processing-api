 ...
 *
 */
var processImage = function (fileName, width, height, style) {
    if (height === void 0) { height = null; }
    if (style === void 0) { style = null; }
    return __awaiter(void 0, void 0, void 0, function () {
        var styleCodes, styleName, inputAsset, outputAsset, inputAssetCheck, outputAssetCheck;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    styleCodes = ['tint', 'greyscale'];
                    styleName = styleCodes.includes(style) ? "_".concat(style) : '';
                    inputAsset = "./assets/".concat(fileName, ".jpg");
                    outputAsset = "./assets/".concat(fileName, "_").concat(width).concat(height ? "_".concat(height) : '').concat(styleName, ".jpg");
